 ...
 */
import { some, isEmpty, get, snakeCase, mapKeys } from 'lodash';
...
export default connect(
	...
	( dispatch, { cart, transaction, selectedSite, redirectTo } ) => ( {
		createRedirect: name => {
			...
			// todo: replace mapKeys with convertToSnakeCase see: https://github.com/Automattic/wp-calypso/pull/26974
			requestRedirect(
				cart,
				mapKeys( transaction.domainDetails, ( v, k ) => snakeCase( k ) ),
				payment
			);
		},
